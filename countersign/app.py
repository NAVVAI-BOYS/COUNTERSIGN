...
def _specimen():
    ...
    claims = [
        ...
        NS(claim_no="CS-0000-02",
           has_outcome=True,
           value_made="A reporting suite the team now runs without any outside help",
           value_saved="Around 30 hours of manual reporting work a month",
           value_optimized="Board reporting moved from a week's turnaround to same day",
        ...
        NS(claim_no="CS-0000-03",
           has_outcome=True, value_made="",
           value_saved="Two client engagements rescued that would have needed a specialist hire",
           value_optimized="Data questions answered in hours instead of weeks",
...
def record_json(slug):
    ...
    return {
        ...
        "claims": [{
            ...
            "value_in_clients_words": ({"generated": c.value_made or None, "saved": c.value_saved or None,
